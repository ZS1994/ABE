...
<html>
  ...
  <body>
 	...
 	<div style="margin:100px auto;width:1000px;height:600px;">
 		...
 		<a href="<%=path %>/login.jsp" target="_parent" style="display:block; width:300px;height:80px;float:left;margin-left:80px;background:url(<%=path %>/FRAMEWORK/image/btn_error.png);">
